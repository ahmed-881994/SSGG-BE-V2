...
class EventService:
    ...
    def search_events(self, requester_member_id: str, name: Optional[str] = None, start_date: Optional[str] = None, end_date: Optional[str] = None, entity_id: Optional[int] = None, include_children: bool = False) -> Dict[str, List[Dict[str, Any]]]:
        ...
        try:
            events = self.event_repository.search_events(requester_member_id=requester_member_id, name=name, start_date=start_date, end_date=end_date, entity_id=entity_id, include_children=include_children)
            if not events:
