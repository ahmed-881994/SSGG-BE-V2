...
class MemberCreateRequest(BaseSchema):
    ...
    parent_national_id_url: Optional[str] = Field(default=None,alias='ParentNationalIdURL', description="The parent's national ID URL of the member", max_length=14)
    club_id_url: Optional[str] = Field(default=None,alias='ClubIdURL', description="The club ID URL of the member", max_length=12)
...
class MemberResponse(BaseSchema):
    ...
    gender: Optional[Literal['male', 'female']] = Field(alias='Gender', description="The gender of the member")
