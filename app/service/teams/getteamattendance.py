    ...
    for record in records:
        ...
        if existing_entry:
            ...
            existing_entry["Attendance"].append({
                ...
                "AttendanceStateName": {
                    "EN": record.get("attendance_state_name_en"),
                    "AR": record.get("attendance_state_name_ar")
                }
            })
        else:
            ...
            row = {
                ...
                "EventStartDate": str(record.get("event_start_date")),
                "EventEndDate": str(record.get("event_end_date")),
